...
class CustomerEditProfileScreen extends StatefulWidget {
  ...
  @override
  _CustomerEditProfileScreenState createState() => _CustomerEditProfileScreenState();
}
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildEditField("Name", Icons.person, nameController),
            const SizedBox(height: 16),
            _buildEditField("Email", Icons.email, emailController),
            const SizedBox(height: 16),
